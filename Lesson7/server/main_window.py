...
from Lesson7.server.stat_window import StatWindow
from Lesson7.server.config_window import ConfigWindow
from Lesson7.server.add_user import RegisterUser
from Lesson7.server.remove_user import DelUserDialog
